...
connections.on('connection', async socket => {
  ...
  // Thêm lại sự kiện getProducers để lấy danh sách các producer hiện có trong phòng
  socket.on('getProducers', callback => {
    // Lấy danh sách các producer trong phòng
    const producerList = streaming.getProducers(socket.id, peers);
    
    // Trả về danh sách producer cho client
